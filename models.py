...
def build_classification_model(args):
    ...
    if args.pretrained_weights is None or args.pretrained_weights =='':
        ...
        if args.model_name.lower() == "vit_base":
            ...
            if args.init.lower() =="random":
                model = timm.create_model('timm/densenet121.tv_in1k', num_classes=args.num_class, pretrained=True)
            elif args.init.lower() =="imagenet_21kto1k":
                model = timm.create_model('timm/swinv2_base_window8_256.ms_in1k', num_classes=args.num_class, pretrained=True)
            elif args.init.lower() =="imagenet_21k":
                model = timm.create_model('timm/swinv2_base_window12_192.ms_in22k', num_classes=args.num_class, pretrained=True)
